(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9261],
  {
    21572: function (t, e, n) {
      ...
      class i extends r {
        constructor(t, e) {
          2 == arguments.length && (t += ` (Received: ${JSON.stringify(e)})`),
            super("ValidationError", `[Validation] ${t}`);
        }
      }
      function o(t, e) {
        if ("function" != typeof t) throw new i(`${e} is not a function`, t);
      }
      function s(t, e) {
        if (null === t || "object" != typeof t)
          throw new i(`${e} is not an object`, t);
      }
      function a(t) {
        let e = !0;
      ...
      class c extends r {
        constructor(t) {
          super("AbortLoadError", ""), (this.loadSegmentNormally = t);
        }
      }
      class l {
        abort(t) {
          if ("object" != typeof t) throw new i("arg should be an object", t);
          throw new c(t.loadSegmentNormally);
        }
      }
      let p =
          (t) =>
          async ({ payload: e, next: n }) => {
            let r = await t();
            a(r),
              (e.obj.context.consent = {
                ...e.obj.context.consent,
                categoryPreferences: r,
              }),
              n(e);
          },
        f = (t) => Array.from(new Set(t)),
        d = (t, e) => e.reduce((e, n) => (n in t && (e[n] = t[n]), e), {}),
        h = async (t, e, n) => {
          let r;
          if (
            !(r = n
              ? f(Object.values(n).reduce((t, e) => t.concat(e)))
              : e.consentSettings?.allCategories || []).length
          )
            throw new i(
      ...
      class v {
        get analytics() {
          return y(this._uninitializedAnalytics);
        }
        constructor(t) {
          !(function (t) {
            if (
              ...
              throw new i("analytics is not an Analytics instance", t);
          })(t),
            (this._uninitializedAnalytics = t),
            (this.loadNormally = t.load.bind(this._uninitializedAnalytics)),
            (this.cdnSettings = new Promise((t) =>
              this.analytics.on("initialize", t)
            ));
        }
        replaceLoadMethod(t) {
        ...
        configureConsentStampingMiddleware({
          getCategories: t,
          pruneUnmappedCategories: e,
          integrationCategoryMappings: n,
        }) {
          let r = p(async () => (e ? h(t, await this.cdnSettings, n) : t()));
          return this.analytics.addSourceMiddleware(r);
        }
        consentChange(t) {
          try {
            a(t);
      ...
      let y = (t) => {
          if (Array.isArray(t)) {
            let e = t._loadOptions ?? {},
              n = window[e?.globalAnalyticsKey ?? "analytics"];
        ...
        g = (t, e) =>
          !!e &&
          !e.hasUnmappedDestinations &&
          Object.keys(t)
            .filter((e) => t[e])
            .every((t) => !e.allCategories.includes(t)),
        m = (...[t]) => {
          !(function (t) {
            if ("object" != typeof t || !t)
              throw new i("Options should be an object", t);
            o(t.getCategories, "getCategories"),
              t.shouldLoadSegment &&
                o(t.shouldLoadSegment, "shouldLoadSegment"),
              t.shouldEnableIntegration &&
                o(t.shouldEnableIntegration, "shouldEnableIntegration"),
              t.shouldDisableSegment &&
                o(t.shouldDisableSegment, "shouldDisableSegment"),
              t.integrationCategoryMappings &&
                s(t.integrationCategoryMappings, "integrationCategoryMappings"),
              t.registerOnConsentChanged &&
                o(t.registerOnConsentChanged, "registerOnConsentChanged");
          })(t);
          let {
            shouldDisableSegment: e,
            getCategories: n,
            shouldLoadSegment: r,
            integrationCategoryMappings: p,
            pruneUnmappedCategories: f,
            shouldEnableIntegration: d,
            registerOnConsentChanged: h,
            shouldLoadWrapper: y,
          } = t;
          return (t) => {
            let i = new v(t),
              o = y?.() || Promise.resolve();
            o.then(() => {
              h?.((t) => i.consentChange(t));
            });
            let s = async (t, s) => {
              let h;
              if (
                (s?.initialPageview &&
                  (i.page(), (s = { ...s, initialPageview: !1 })),
                !(await e?.()))
              ) {
                try {
                  await o, (h = (await r?.(new l())) || (await n()));
                } catch (e) {
                  if (e instanceof c) {
                    !0 === e.loadSegmentNormally && i.loadNormally(t, s);
                    return;
                  }
                  throw e;
                }
                return (
                  a(h),
                  i.configureConsentStampingMiddleware({
                    getCategories: n,
                    integrationCategoryMappings: p,
                    pruneUnmappedCategories: f,
                  }),
                  i.loadNormally(t, {
                    ...s,
                    updateCDNSettings: u(
                      (t) => (t.remotePlugins ? w(t, h, p, d) : t),
                      s?.updateCDNSettings || ((t) => t)
                    ),
                    disable: _(h, s?.disable),
                  })
                );
              }
            };
            return i.replaceLoadMethod(s), t;
          };
        },
        b = (t) => {
          if (
            ...
            "object" == typeof t.consentSettings &&
            t.consentSettings &&
        ...
        w = (t, e, n, r) => {
          let { remotePlugins: i, integrations: o } = t,
            s = (t) => {
              let i = n ? n[t] : b(o[t]);
              return r
                ? r(i || [], e, { creationName: t })
                : !i || !i.length || i.every((t) => e[t]);
            };
          return Object.keys(o).reduce(
            (t, e) => (
              s(e) ||
                ((t.remotePlugins =
                  t.remotePlugins &&
                  t.remotePlugins.filter((t) => t.creationName !== e)),
                delete t.integrations[e]),
              t
            ),
            { ...t, remotePlugins: i, integrations: { ...o } }
          );
        },
        _ = (t, e) =>
          !0 === e ||
          ((n) => g(t, n.consentSettings) || ("function" == typeof e && e(n)));
    },
    76312: function (t, e, n) {
      "use strict";
      function r(t, e) {
                ...
                var t = this._logs.reduce(function (t, e) {
                  ...
                  var a =
                    null !==
                      ...
                      : "";
                  return (
                    t[a] && (a = "".concat(a, "-").concat(Math.random())),
                    (0, o.pi)((0, o.pi)({}, t), (((n = {})[a] = s), n))
                  );
                }, {});
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.pushWithBackoff = function (t) {
              ...
              return (
                !(a > this.maxAttempts || this.includes(t)) &&
                (setTimeout(function () {
                  s.queue.push(t),
    ...
    66837: function (t, e, n) {
      ...
      function f(t, e, n, r, i) {
        var o,
          ...
          c = [t, e, n, r, i],
          p = c.filter(l.HD);
        void 0 !== p[0] && void 0 !== p[1] && ((a = p[0]), (u = p[1])),
          1 === p.length && ((a = null), (u = p[0]));
        var f = c.find(l.mf),
          d = c.filter(function (t) {
            return null === u ? (0, l.PO)(t) : (0, l.PO)(t) || null === t;
          }),
      ...
      var d = function (t) {
        return function () {
          for (var e, n, r, i = [], o = 0; o < arguments.length; o++)
            i[o] = arguments[o];
          for (
            var s = {}, a = ["callback", "options", "traits", "id"], u = 0;
            u < i.length;
            u++
          ) {
            var c = i[u],
      ...
      var v = n(34699),
        ...
        I = function (t) {
          var e = t.c,
            ...
            s = t.t,
            a = e ? S(e) : n,
            u = e ? (e.indexOf("?") > -1 ? e : e + r) : x(i);
          return { path: a, referrer: o, search: r, title: s, url: u };
        },
        j = function () {
        ...
        D = (function (t) {
          ...
          return (
            (0, o.ZT)(e, t),
            (e.prototype.maybeUpdateAnonId = function (t) {
            ...
            (e.prototype.page = function (e, n, r, i, o, s) {
              var a = t.prototype.page.call(this, e, n, r, i, o);
              return O(a, s), a;
            }),
            (e.prototype.screen = function (e, n, r, i, o, s) {
              var a = t.prototype.screen.call(this, e, n, r, i, o);
              return O(a, s), a;
            }),
            ...
            return (
              ...
              (t.prototype.page = function (t, e, n, r, i) {
                ...
                return (
                  null !== t &&
                    ((a.category = t),
                    (a.properties =
                      null !== (s = a.properties) && void 0 !== s ? s : {}),
                    (a.properties.category = t)),
                  null !== e && (a.name = e),
                  this.normalize((0, o.pi)((0, o.pi)({}, this.baseEvent()), a))
                );
              }),
              (t.prototype.screen = function (t, e, n, r, i) {
                ...
                return (
                  null !== t && (s.category = t),
                  null !== e && (s.name = e),
                  this.normalize((0, o.pi)((0, o.pi)({}, this.baseEvent()), s))
                );
              }),
              ...
              (t.prototype.alias = function (t, e, n, r) {
                ...
                return (null !== e && (i.previousId = e), void 0 === t)
                  ? this.normalize(
                      (0, o.pi)((0, o.pi)({}, i), this.baseEvent())
                    )
                  : this.normalize(
                      (0, o.pi)((0, o.pi)({}, this.baseEvent()), i)
                    );
              }),
              ...
              (t.prototype.normalize = function (t) {
                var e,
                  ...
                  s = Object.keys(
                    ...
                    var r, i;
                    return (0,
                    o.pi)((0, o.pi)({}, e), (((r = {})[n] = !!(null === (i = t.integrations) || void 0 === i ? void 0 : i[n])), r));
                  }, {});
                t.options =
                  ((e = t.options || {}),
                  (n = function (t, e) {
                ...
                var a = (0, o.pi)(
                  ...
                  h = (0, o.pi)(
                    (0, o.pi)(
                      (0, o.pi)((0, o.pi)({ timestamp: new Date() }, d), {
                        context: c,
                        integrations: a,
                      }),
                      p
                ...
                return (
                  this.settings.onFinishedEvent(h),
                  (function (t) {
                    if (!(0, l.Gg)(t)) throw new P("Event", "is nil");
                    if ("object" != typeof t) throw new P("Event", E);
                  })(h),
                  (function (t) {
                    if (!(0, l.HD)(t.type)) throw new P(".type", M);
                  })(h),
                  (function (t) {
                    if (!(0, l.HD)(t.messageId)) throw new P(".messageId", M);
                  })(h),
                  "track" === h.type &&
                    ((function (t) {
                      if (!(0, l.HD)(t.event)) throw new P(".event", M);
                    })(h),
                    (function (t) {
                      if (!(0, l.PO)(t.properties))
                        throw new P(".properties", E);
                    })(h)),
                  ["group", "identify"].includes(h.type) &&
                    (function (t) {
                      if (!(0, l.PO)(t.traits)) throw new P(".traits", E);
                    })(h),
                  h
                );
              }),
        ...
        q = (function (t) {
          function e(e) {
            return (
              t.call(this, "string" == typeof e ? new F.$(4, e) : e) || this
            );
          }
          return (
            (0, o.ZT)(e, t),
                    ...
                    switch (o.label) {
                      case 0:
                        if (
                          (this.plugins.push(e),
                          (r = function (n) {
                            s.failedInitializations.push(e.name),
                              s.emit("initialization_failure", e),
                    ...
                    switch (o.label) {
                      case 0:
                        ...
                        t.attempts > 1 && this.emit("delivery_retry", t),
                          ...
                          (o.label = 1);
                      case 1:
                        if (!(a < u.length)) return [3, 4];
                        return (c = u[a]), [4, (0, G.z)(t, c)];
                      case 2:
                        (l = o.sent()) instanceof J._ && (t = l),
                      ...
                      case 5:
                        ...
                        return (d = f[p]), [4, (0, G.a)(t, d)];
                      case 6:
                        (l = o.sent()) instanceof J._ && (t = l),
                          this.emit("message_enriched", t, d),
                          (o.label = 7);
                      case 7:
                        return p++, [3, 5];
                      case 8:
                        return (
                          (v = (h = this.availableExtensions(
      ...
      function B(t) {
        return (
          ...
          t.stores.every(function (t) {
            return Object.values(z).includes(t);
          })
        );
      }
      function Z(t) {
      ...
      var W = (function () {
          function t(e) {
            void 0 === e && (e = t.defaults),
              (this.options = (0, o.pi)((0, o.pi)({}, t.defaults), e));
          }
          return (
            ...
            (t.prototype.set = function (t, e) {
              "string" == typeof e
                ? V.set(t, e, this.opts())
                : null === e
                ? V.remove(t, this.opts())
                : V.set(t, JSON.stringify(e), this.opts());
            }),
            (t.prototype.remove = function (t) {
      ...
      function Y(t, e) {
        return t.map(function (t) {
          return e && t === z.Cookie ? { name: t, settings: e } : t;
        });
      }
      var X = {
          persist: !0,
          ...
          function t(t, e) {
            ...
            (this.options = {}),
              (this.id = function (t) {
                ...
                var e = a.identityStore.getAndSync(a.idKey);
                void 0 !== t &&
                  (a.identityStore.set(a.idKey, t),
                  t !== e && null !== e && null !== t && a.anonymousId(null));
                var n = a.identityStore.getAndSync(a.idKey);
                if (n) return n;
                var r = a.legacyUserStore.get(X.cookie.oldKey);
              ...
              (this.anonymousId = function (t) {
                ...
                if (void 0 === t) {
                  var r =
                    null !== (e = a.identityStore.getAndSync(a.anonKey)) &&
                    void 0 !== e
                      ? e
                      : null === (n = a.legacySIO()) || void 0 === n
                      ? void 0
                      : n[0];
                  if (r) return r;
                }
                return (
                  ...
                  a.identityStore.getAndSync(a.anonKey)
                );
              }),
              (this.traits = function (t) {
                ...
                if (!a.options.disable)
                  return (
                    null === t && (t = {}),
                    t && a.traitsStore.set(a.traitsKey, null != t ? t : {}),
                    null !== (e = a.traitsStore.get(a.traitsKey)) &&
                    void 0 !== e
                      ? e
                      : {}
                  );
              }),
              (this.options = (0, o.pi)((0, o.pi)({}, X), t)),
            ...
            var u = this.legacyUserStore.get(X.cookie.oldKey);
            u &&
              "object" == typeof u &&
              (u.id && this.id(u.id), u.traits && this.traits(u.traits)),
              L(this);
          }
          return (
        ...
        ts = function (t, e, n) {
          n.getCalls(t).forEach(function (t) {
            th(e, t).catch(console.error);
          });
        },
        ta = ts.bind(void 0, "on"),
        tu = ts.bind(void 0, "setAnonymousId"),
        tc = function (t, e) {
          e.toArray().forEach(function (e) {
            setTimeout(function () {
              th(t, e).catch(console.error);
            }, 0);
          });
        },
        tl = function (t) {
          if (tp(t)) return I(t.pop());
        },
        tp = function (t) {
          return (function (t) {
            if (!(0, l.PO)(t) || "bpc" !== t.__t) return !1;
            for (var e in t) if (!_.includes(e)) return !1;
            return !0;
          })(t[t.length - 1]);
        },
        tf = function (t, e, n, r) {
            ...
            (t.prototype.push = function () {
              ...
              e.forEach(function (e) {
                [
                  ...
                  !tp(e.args) &&
                  (e.args = (0, o.ev)((0, o.ev)([], e.args, !0), [j()], !1)),
                  t.calls[e.method]
      ...
      var tv = (function () {
              ...
              return function () {
                ...
                return e.instance
                  ...
                  : new Promise(function (n, i) {
                      e._preInitBuffer.push(new tf(t, r, n, i));
                    });
              };
            }),
              ...
              return function () {
                ...
                return (
                  e.instance
                    ...
                    : e._preInitBuffer.push(new tf(t, r)),
                  e
                );
              };
            }),
        ...
        tg = (0, ti.R)(),
        tm = null == tg ? void 0 : tg.analytics;
      function tb() {
        console.warn(ty);
      }
      var tw = (function (t) {
          function e(e, n, r, i, s) {
            var a,
              ...
              d,
              h = this;
            ((h = t.call(this) || this)._debug = !1),
              (h.initialized = !1),
              (h.user = function () {
                return h._user;
              }),
              (h.init = h.initialize.bind(h)),
              (h.log = tb),
              (h.addIntegrationMiddleware = tb),
              (h.listeners = tb),
              (h.addEventListener = tb),
              (h.removeAllListeners = tb),
              (h.removeListener = tb),
              (h.removeEventListener = tb),
              (h.hasListeners = tb),
              (h.add = tb),
              (h.addIntegration = tb);
            var v = null == n ? void 0 : n.cookie,
              y =
                null !==
                  (p = null == n ? void 0 : n.disableClientPersistence) &&
                void 0 !== p &&
                p;
            (h.settings = e),
              (h.settings.timeout =
                null !== (f = h.settings.timeout) && void 0 !== f ? f : 300),
              (h.queue =
                null != r
                  ? r
                  : ((a = "".concat(e.writeKey, ":event-queue")),
                    void 0 === (u = null == n ? void 0 : n.retryQueue) &&
                      (u = !1),
                    void 0 === (c = y) && (c = !1),
                    (l = u ? 10 : 1),
                    new q(c ? new N.Z(l, []) : new F.$(l, a))));
            var g = null == n ? void 0 : n.storage;
            return (
              (h._universalStorage = h.createStore(y, g, v)),
              (h._user =
                null != i
                  ? i
                  : new tt(
          ...
          return (
              ...
              return (0, o.mG)(this, void 0, void 0, function () {
                ...
                return (0, o.Jh)(this, function (o) {
                  return (
                    ...
                    [
                      2,
                      this._dispatch(u, a).then(function (t) {
                        return (
                          c.emit(
                            "track",
                            r,
            ...
            (e.prototype.identify = function () {
              ...
              return (0, o.mG)(this, void 0, void 0, function () {
                ...
                return (0, o.Jh)(this, function (o) {
                  return (
                    (e = tl(t)),
                    (r = (n = d(this._user).apply(void 0, t))[0]),
                    (i = n[1]),
                    (s = n[2]),
                    (a = n[3]),
            ...
            (e.prototype.group = function () {
              ...
              var c = this._group.id(),
                ...
                p = this.eventFactory.group(c, l, a, this.integrations, r);
              return this._dispatch(p, u).then(function (e) {
                return (
                  t.emit(
                    "group",
                    e.event.groupId,
            ...
            (e.prototype.trackClick = function () {
              ...
              return (0, o.mG)(this, void 0, void 0, function () {
                ...
                return (0, o.Jh)(this, function (r) {
                  switch (r.label) {
                    case 0:
                      return [4, n.e(8119).then(n.bind(n, 34010))];
                    case 1:
                      return [
                        2,
                            ...
                            return (0, o.Jh)(this, function (o) {
                              switch (o.label) {
                                case 0:
                                  return [
                                    4,
                                    Promise.resolve().then(n.bind(n, 32025)),
                                  ];
                                case 1:
                                  return (
            ...
            (e.prototype.addDestinationMiddleware = function (t) {
              for (var e = [], n = 1; n < arguments.length; n++)
                e[n - 1] = arguments[n];
              return (
                this.queue.plugins.filter(C).forEach(function (n) {
                ...
                return (0, o.Jh)(this, function (e) {
                  switch (e.label) {
                    case 0:
                      ...
                      return [4, n.e(3096).then(n.bind(n, 81596))];
                    case 1:
            ...
            (e.prototype.noConflict = function () {
              return console.warn(ty), (0, to.ql)(null != tm ? tm : this), this;
            }),
            (e.prototype.normalize = function (t) {
              return console.warn(ty), this.eventFactory.normalize(t);
            }),
            Object.defineProperty(e.prototype, "failedInitializations", {
              get: function () {
                return console.warn(ty), this.queue.failedInitializations;
              },
              enumerable: !1,
              configurable: !0,
            }),
            ...
            (e.prototype.initialize = function (t, e) {
              return (0, o.mG)(this, void 0, void 0, function () {
                return (0, o.Jh)(this, function (t) {
                  return console.warn(ty), [2, Promise.resolve(this)];
                });
              });
            }),
            (e.prototype.pageview = function (t) {
              return (0, o.mG)(this, void 0, void 0, function () {
                return (0, o.Jh)(this, function (e) {
                  switch (e.label) {
                    case 0:
                      return console.warn(ty), [4, this.page({ path: t })];
                    case 1:
          ...
          (this.name = "Page Enrichment"),
            ...
            (this.enrich = function (e) {
              var n,
                ...
                p = e.event.context,
                f = p.page.search || "",
                d = "object" == typeof f ? tO(f) : f;
              (p.userAgent = navigator.userAgent),
                (p.userAgentData = t.userAgentData);
              var h = navigator.userLanguage || navigator.language;
              void 0 === p.locale && void 0 !== h && (p.locale = h),
                (null !== (c = p.library) && void 0 !== c) ||
                  (p.library = {
                    name: "analytics.js",
                    version: ""
                      .concat("web" === (0, tI.B)() ? "next" : "npm:next", "-")
                      .concat(tr.i),
                  }),
                d &&
                  !p.campaign &&
                  (p.campaign =
                    ((u = d).startsWith("?") && (u = u.substring(1)),
                    (u = u.replace(/\?/g, "&"))
                      .split("&")
                      .reduce(function (t, e) {
                        var n = e.split("="),
              ...
              v && (p.amp = { id: v }),
                (s = (i = new U(
                  null !== (l = t.instance.options.disableClientPersistence) &&
                  void 0 !== l &&
                  l
                    ? []
                    : [
                        new W(
                          (function () {
                            if (r) return r;
                            var t = H(window.location.href);
                            return (
                              (r = { expires: 31536e6, secure: !1, path: "/" }),
                              t && (r.domain = t),
                              r
                            );
                          })()
                ...
                (a =
                  null !==
                    ...
                    ? n
                    : s) &&
                  (p && (p.referrer = (0, o.pi)((0, o.pi)({}, p.referrer), a)),
                  i.set("s:context.referrer", a));
              try {
                ...
                return (0, o.Jh)(this, function (n) {
                  switch (n.label) {
                    case 0:
                      return [
                        4,
                        (0, tM.applyDestinationMiddleware)(
                          this.name,
                          t.event,
                          this.middleware
                        ),
            ...
            return (0, o.mG)(i, void 0, void 0, function () {
              ...
              return (0, o.Jh)(this, function (s) {
                switch (s.label) {
                  ...
                  case 1:
                    return (
                      (i = s.sent()), (t = !1), e.todo > 0 && r(t, i, n, r), [2]
                    );
                }
              });
            });
      ...
      var tT = n(28678),
        tG = (0, ti.R)(),
        tq =
          null !== (i = tG.__SEGMENT_INSPECTOR__) && void 0 !== i
            ? i
            : (tG.__SEGMENT_INSPECTOR__ = {}),
        tL = function (t) {
          var e;
          return null === (e = tq.attach) || void 0 === e
            ? void 0
            : e.call(tq, t);
        },
        tz = n(66958),
                ...
                t.call(this, function (t) {
                  return i.then(function (e) {
                    return (function (t, e, r) {
                      var i, s, l, p, f, d, h, g, m, b;
                      return (
                        void 0 === e && (e = {}),
                        (0, o.mG)(this, void 0, void 0, function () {
                          var w, _, x, S, I, j, O, k, P, M, E;
                          return (0, o.Jh)(this, function (A) {
                            var D, C, J, T;
                            switch (A.label) {
                              case 0:
                                if (!0 === e.disable)
                                  return [2, [new t_(), y._.system()]];
                                if (
                                  (e.globalAnalyticsKey &&
                                    (0, to.jV)(e.globalAnalyticsKey),
                                  t.cdnURL && (0, u.UH)(t.cdnURL),
                                  e.initialPageview &&
                                    r.push(new tf("page", [])),
                                  !(
                                    null !== (i = t.cdnSettings) && void 0 !== i
                                  ))
                                )
                                  return [3, 1];
                                return (_ = i), [3, 3];
                              case 1:
                                return [
                                  ...
                                  ((D = t.writeKey),
                                  (J =
                                    null != (C = t.cdnURL) ? C : (0, u.Vl)()),
                                  (0, c.h)(
                                    ""
                                      .concat(J, "/v1/projects/")
                                      .concat(D, "/settings")
                                  )
                                    .then(function (t) {
                                      return t.ok
                              ...
                              case 3:
                                if (
                                  ((w = _),
                                  e.updateCDNSettings &&
                                    (w = e.updateCDNSettings(w)),
                                  "function" != typeof e.disable)
                                )
                                  return [3, 5];
                              ...
                              case 5:
                                return (
                                  ...
                                  tL(
                                    (S = new tw(
                                      t,
                                      (e = (0, o.pi)({ retryQueue: x }, e))
                                    ))
                                  ),
                                  (I =
                                    null !== (p = t.plugins) && void 0 !== p
                                      ? p
                                      : []),
                                  (j =
                                    null !== (f = t.classicIntegrations) &&
                                    void 0 !== f
                                      ? f
                                      : []),
                                  (O =
                                    null === (d = e.integrations) ||
                                    void 0 === d
                                      ? void 0
                                      : d["Segment.io"]),
                                  tz.j.initRemoteMetrics(
                                    (0, o.pi)((0, o.pi)({}, w.metrics), {
                                      host:
                                        null !==
                                          (h =
                                            null == O ? void 0 : O.apiHost) &&
                                        void 0 !== h
                                          ? h
                                          : null === (g = w.metrics) ||
                                            void 0 === g
                                                      ...
                                                      n
                                                        ...
                                                        .then(function (t) {
                                                          var n =
                                                            t.remoteMiddlewares;
                                                          return (0,
                                                          o.mG)(M, void 0, void 0, function () {
                                                            return (0,
                                                            o.Jh)(this, function (t) {
                                                              switch (t.label) {
                                                                case 0:
                                                                  return [
                                                                    4,
                              ...
                              case 6:
                                if (
                                  ((k = A.sent()),
                                  (P =
                                    null !== (m = window.location.search) &&
                                    void 0 !== m
                                      ? m
                                      : ""),
                                  (M =
                                    null !== (b = window.location.hash) &&
                                    void 0 !== b
                                      ? b
                                      : ""),
                                  !(E = P.length
                                ...
                                return [
                                  4,
                                  S.queryString(E).catch(console.error),
                                ];
                              case 7:
                                A.sent(), (A.label = 8);
                              case 8:
    ...
    31136: function (t, e, n) {
      ...
      function r(t, e) {
        var n = e.methodName,
          ...
          o = e.didError;
        t.stats.increment(
          "analytics_js.integration.invoke".concat(
            void 0 !== o && o ? ".error" : ""
          ),
          1,
          [
    ...
    76519: function (t, e, n) {
      ...
      function i(t, e) {
        ...
        return new Promise(function (n, r) {
          ...
          for (
            var s = 0, a = Object.entries(null != e ? e : {});
            s < a.length;
            s++
          ) {
            var u = a[s],
    ...
    68199: function (t, e, n) {
      ...
      function p(t, e, n) {
        ...
        if (s) {
          a.setItem(r, JSON.stringify(new Date().getTime() + 50)),
            e(),
            a.removeItem(r);
          return;
        }
                ...
                try {
                  p(n, function () {
                    ...
                    (e = u(o)),
                      ...
                      a.setItem(o, JSON.stringify(Object.values(n))),
                      (l = i.seen),
                      (p = c(s)),
                      a.setItem(
                        s,
                        JSON.stringify((0, r.pi)((0, r.pi)({}, p), l))
                      );
                  });
                } catch (t) {
                  console.error(t);
    ...
    12261: function (t, e, n) {
      ...
      function l(t, e) {
        (e = e || {}),
          ...
          "timestamp" in t
            ? (t.timestamp = a.default(t.timestamp))
      ...
      (p.proxy = function (t) {
        ...
        return r
          ? ("function" == typeof r && (r = r.call(this) || {}),
            0 === n.length || (r = u.default(r, n.join("."))),
        ...
        (p.options = function (t) {
          ...
          if (this.enabled(t)) {
            var r = this.integrations(),
              i = r[t] || u.default(r, t);
            return (
              "object" != typeof i && (i = u.default(this.options(), t)),
              "object" == typeof i ? i : {}
            );
          }
        }),
    ...
    86103: function (t) {
      function e(t) {
        return function (e, n, r, o) {
          var s,
            a = o && "function" == typeof o.normalizer ? o.normalizer : i;
          n = a(n);
          for (var u = !1; !u; )
            !(function () {
              for (s in e) {
